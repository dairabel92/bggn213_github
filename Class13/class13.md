...
Now we got rid of our stuff \> How many genes should we have left
...
the base r `prcomp` funciton should help with, you also need to scale.
`t()`
...
> Q. What doies your score pot (PC1 vs PC2 plot) look like hwne coplored
> by condition (controlv s knockdown)
...
```
    ...
    Info: Working in directory C:/Users/daira/OneDrive/Desktop/BGGN213/bggn213_github/Class13
...
A: Based on the results table, the ones that had the most significant
are the CNN3 and TENT5C. The factors that cause differences are the
types of statistical tests on the data.
